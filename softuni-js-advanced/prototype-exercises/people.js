function solution() {
    class Employee {
        ...
        work() {
            let w = this.tasks.shift();
            console.log(w);
            this.tasks.push(w);
        }
        collectSalary() {
            let s = this.dividend  !== undefined ? this.dividend  : 0;
            console.log(`${this.name} received ${this.salary + s} this month.`)
        }
    }
    ...
    class Manager extends Employee {
        constructor(name, age) {
            ...
            this.tasks.push(`${this.name} is a preparing a quarterly report.`);
        }
    }
    return {
        Employee,
